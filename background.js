...
// ⚡ Bolt Optimization: Use precompiled global regex for significantly faster extraction than manual string scanning loops in JS
const URL_EXTRACT_REGEX = /https?:\/\/[^\s"'<>]+/g;

function extractUrls(text) {
    const urlSet = new Set();
    let match;
    URL_EXTRACT_REGEX.lastIndex = 0; // Ensure regex state is reset
