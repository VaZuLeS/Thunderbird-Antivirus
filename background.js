...
// ⚡ Bolt Optimization: Using a pre-compiled global regex pattern for URL extraction avoids manual string scanning loops and significantly outperforms chained charCodeAt checks in V8.
...
function extractUrls(text) {
    ...
    const urls = new Array(urlSet.size);
    let i = 0;
