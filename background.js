...
// ⚡ Bolt Optimization: Replaced complex manual string scanning loops (using indexOf and charCodeAt) with a highly optimized global regular expression
...
function extractUrls(text) {
    ...
    if (matches) {
        // ⚡ Bolt Optimization: Use traditional for-loop over array methods for performance
